...
use WordPress\DuetGAIConnector\Models\TextGeneration\CustomTextGenerationModel;
use WordPress\DuetGAIConnector\Metadata\CustomTextModelMetadataDirectory;
